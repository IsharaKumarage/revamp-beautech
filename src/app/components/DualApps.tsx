export default function DualApps() {
  return (
    <section className="px-8 py-20 bg-[#F5F0E8]">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                height: '88px',
                borderRadius: '24px',
                background: 'linear-gradient(135deg, #C8A2A2 0%, #A07878 100%)',
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="#"
                className="inline-flex items-center gap-3 px-6 py-3 transition-transform duration-200 hover:scale-105"
                style={{
              ...
              >
                ...
                <div className="text-left">
                  <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)' }}>Download on the</div>
                  <div style={{ fontSize: '16px', fontWeight: 600, color: 'white', lineHeight: 1 }}>App Store</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)' }}>GET IT ON</div>
